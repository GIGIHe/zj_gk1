...
$("#zhuce").click(function() {
	...
	// 	return false;
	// }
	$.getJSON("http://bj.offcn.com/index.php?m=formguide&c=index&a=formlogin&type=zhuce&formid=" + formid + "&username=" + username + "&mobile=" + Myphone + "&yzm=" + yzm + "&callback=?", function(json) {
		if(json.status == 1) {
			alert("注册成功，去登陆");
			submitswitch = true;
